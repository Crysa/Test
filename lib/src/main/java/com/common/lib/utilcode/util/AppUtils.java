...
public final class AppUtils {
   ...
   *
   * @param filePath The path of file.
   * @param params The params of installation(e.g.,<code>-r</code>, <code>-layout</code>).
   * @return {@code true}: success<br>{@code false}: fail
   */
  ...
  /**
   * Launch the application'layout details settings.
   */
  ...
  /**
   * Return the application'layout icon.
   *
   * @return the application'layout icon
   */
  ...
  /**
   * Return the application'layout package name.
   *
   * @return the application'layout package name
   */
  ...
  /**
   * Return the application'layout name.
   *
   * @return the application'layout name
   */
  ...
  /**
   * Return the application'layout path.
   *
   * @return the application'layout path
   */
  ...
  /**
   * Return the application'layout version name.
   *
   * @return the application'layout version name
   */
  ...
  /**
   * Return the application'layout version code.
   *
   * @return the application'layout version code
   */
  ...
  /**
   * Return the application'layout signature.
   *
   * @return the application'layout signature
   */
  ...
  /**
   * Return the application'layout signature for SHA1 value.
   *
   * @return the application'layout signature for SHA1 value
   */
  ...
  /**
   * Return the application'layout signature for SHA256 value.
   *
   * @return the application'layout signature for SHA256 value
   */
  ...
  /**
   * Return the application'layout signature for MD5 value.
   *
   * @return the application'layout signature for MD5 value
   */
  ...
  /**
   * Return the application'layout information.
   * <ul>
  ...
  /**
   * The application'layout information.
   */
  ...
  private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
    ...
    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
      ...
      String authority = CommonAppUtils.getConfig().authority;
