...
public final class BarUtils {
  ...
  /**
   * Return the status bar'layout height.
   *
   * @return the status bar'layout height
   */
  ...
  /**
   * Set the status bar'layout visibility.
   *
   * @param activity The activity.
   * @param isVisible True to set status bar visible, false otherwise.
   */
  public static void setStatusBarVisibility(@NonNull final Activity activity,
      final boolean isVisible,View marginTop) {
    setStatusBarVisibility(activity.getWindow(), isVisible,marginTop);
  }
  ...
  public static void setStatusBarVisibility(@NonNull final Window window,
    ...
    if (isVisible) {
      ...
      addMarginTopEqualStatusBarHeight(marginTop);
    } else {
      window.addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
      hideColorView(window);
      hideAlphaView(window);
      if (marginTop == null) return;
      subtractMarginTopEqualStatusBarHeight(marginTop);
    }
  }
  ...
  /**
   * Set the status bar'layout light mode.
   *
   * @param activity The activity.
  ...
  /**
   * Add the top margin size equals status bar'layout height for view.
   *
   * @param view The view.
   */
  ...
  /**
   * Subtract the top margin size equals status bar'layout height for view.
   *
   * @param view The view.
   */
...
/*
  ...
  /**
   * Set the status bar'layout color.
   *
   * @param activity The activity.
   * @param color The status bar'layout color.
   */
   ...
   * @param activity The activity.
   * @param color The status bar'layout color.
   * @param alpha The status bar'layout alpha which isn't the same as alpha in the color.
   */
  public static void setStatusBarColor(@NonNull final Activity activity,
      @ColorInt final int color,
  ...
  public static void setStatusBarDrawable(@NonNull final Activity activity,
      @DrawableRes final int res) {
    hideAlphaView(activity);
    transparentStatusBar(activity);
    addStatusBarDrawable(activity, res, false);
  }
  ...
  public static void setStatusBarColor(@NonNull final View fakeStatusBar,
    ...
    transparentStatusBar(ContextHelper.getActivity(fakeStatusBar));
  ...
  /**
   * Set the status bar'layout alpha.
   *
   * @param activity The activity.
   */
   ...
   *
   * @param activity The activity.
   * @param alpha The status bar'layout alpha.
   */
  public static void setStatusBarAlpha(@NonNull final Activity activity,
      @IntRange(from = 0, to = 255) final int alpha) {
  ...
  /**
   * Set the status bar'layout color for DrawerLayout.
  ...
  /**
   * Set the status bar'layout alpha for DrawerLayout.
   * <p>DrawLayout must add {@code android:fitsSystemWindows="true"}</p>
   *
   * @param activity The activity.
  ...
  private static void addStatusBarDrawable(final Activity activity, final int res,
      boolean isDecor) {
    ViewGroup parent = isDecor ?
        (ViewGroup) activity.getWindow().getDecorView() :
        (ViewGroup) activity.findViewById(android.R.id.content);
    ...
    if (fakeStatusBarView != null) {
      ...
      fakeStatusBarView.setBackground(ContextCompat.getDrawable(activity, res));
    } else {
      parent.addView(createDrawableStatusBarView(activity, res));
    }
  }
  ...
  private static View createDrawableStatusBarView(final Context context,
      @DrawableRes final int res) {
    View statusBarView = new View(context);
    statusBarView.setLayoutParams(new LinearLayout.LayoutParams(
        ViewGroup.LayoutParams.MATCH_PARENT, getStatusBarHeight()));
    statusBarView.setBackground(ContextCompat.getDrawable(statusBarView.getContext(), res));
    statusBarView.setTag(TAG_COLOR);
    return statusBarView;
  }
  ...
  /**
   * Return the action bar'layout height.
   *
   * @return the action bar'layout height
   */
  ...
  /**
   * Set the notification bar'layout visibility.
   * <p>Must hold
  ...
  /**
   * Return the navigation bar'layout height.
   *
   * @return the navigation bar'layout height
   */
  ...
  /**
   * Set the navigation bar'layout visibility.
   *
   * @param activity The activity.
  ...
  /**
   * Set the navigation bar'layout color.
   *
   * @param activity The activity.
   * @param color The navigation bar'layout color.
   */
