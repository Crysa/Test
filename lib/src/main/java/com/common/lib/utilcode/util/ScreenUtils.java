...
public final class ScreenUtils {
   ...
   *
   * @param activity The activity.
   * @param designWidthInPx The size of design diagram'layout width, in pixel.
   */
  public static void adaptScreen4VerticalSlide(final Activity activity,
      final int designWidthInPx) {
    adaptScreen4VerticalSlide(activity, designWidthInPx, true);
  }

  public static void adaptScreen4VerticalSlide(final Activity activity,
      final int designWidthInPx, boolean save) {
    adaptScreen(activity, designWidthInPx, true, save);
  }
   ...
   *
   * @param activity The activity.
   * @param designHeightInPx The size of design diagram'layout height, in pixel.
   */
  public static void adaptScreen4HorizontalSlide(final Activity activity,
      final int designHeightInPx) {
    adaptScreen4HorizontalSlide(activity, designHeightInPx, true);
  }

  public static void adaptScreen4HorizontalSlide(final Activity activity,
      final int designHeightInPx, boolean save) {
    adaptScreen(activity, designHeightInPx, false, save);
  }
  ...
  private static void adaptScreen(final Activity activity,
      final int sizeInPx,
      final boolean isVerticalSlide, final boolean save) {
