...
public final class ToastUtils {
  ...
  private static int sTextGravity = Gravity.NO_GRAVITY;
  ...
  private static int sPaddingTop = 20;
  private static int sPaddingStart = 20;
  private static int sPaddingEnd = 20;
  private static int sPaddingBottom = 20;
  ...
  public static void setTextGravity(final int gravity) {
    sTextGravity = gravity;
  }
  ...
  public static void setPadding(int padding) {
    ToastUtils.sPaddingTop = padding;
    ToastUtils.sPaddingStart = padding;
    ToastUtils.sPaddingEnd = padding;
    ToastUtils.sPaddingBottom = padding;
  }

  public static void setPadding(int paddingStart, int paddingEnd, int paddingTop,
      int paddingBottom) {
    ToastUtils.sPaddingTop = paddingTop;
    ToastUtils.sPaddingStart = paddingStart;
    ToastUtils.sPaddingEnd = paddingEnd;
    ToastUtils.sPaddingBottom = paddingBottom;
  }
    ...
    HANDLER.post(new Runnable() {
      ...
      public void run() {
        ...
        if (sGravity != -1 || sXOffset != -1 || sYOffset != -1) {
          ...
          tvMessage.setGravity(sTextGravity);
          tvMessage.setPadding(sPaddingStart, sPaddingTop, sPaddingEnd, sPaddingBottom);
        }
        setBg(tvMessage);
        showToast();
      }
  ...
  private static void showToast() {
    if (mInterceptor != null && mInterceptor.onShow()) {
      return;
    }
    sToast.show();
  }
